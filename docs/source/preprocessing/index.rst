...
See the script ``preprocess_rio.sh`` in the ``scripts`` folder generated by the
CRATE installer.
...
See the script ``preprocess_systmone.sh`` in the ``scripts`` folder generated by the
CRATE installer.
...
See the script ``load_ons_postcode_database.sh`` in the ``scripts`` folder generated by the
CRATE installer.
