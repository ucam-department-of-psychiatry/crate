...
def insert_note(patient_id, note):
    db.db_exec("""
        INSERT INTO notes
            (patient_id, note)
        VALUES
...
insert_patient(patient_id, "Ronald Gibbet", "MacDonald",
               datetime.datetime(day=11, month=11, year=1911), 123456,
               "(01223)-123456", "CB2 3EB")
insert_note(patient_id, u"""
    Ronald MacDonald lived on a farm and kept a gibbet for scaring off small
    animals. He was born on 11 Nov 1911 and was very proud of this.
...
# More special ones
insert_patient(patient_id, "Bob D'Souza", "",
               datetime.datetime(day=11, month=11, year=1911), 123456,
               "(01223)-123456", "CB2 3EB")
insert_note(patient_id, u"""
...
for p in range(PATIENTS):
    ...
    phone = "123456"
    postcode = "CB2 3EB"
    insert_patient(patient_id, forename, surname, dob, nhsnum, phone, postcode)
