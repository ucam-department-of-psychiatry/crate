# -*- coding: utf-8 -*-
# Generated by Django 1.9c1 on 2015-11-25 18:48
from __future__ import unicode_literals

import consent.models
import consent.storage
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_route', models.CharField(choices=[('e', 'E-mail'), ('w', 'Web')], max_length=1)),
                ('email_choice', models.CharField(choices=[('y', 'Yes'), ('n', 'No'), ('more', 'Tell me more')], max_length=4)),
                ('response', models.CharField(choices=[('R', 'R: Clinician asks RDBM to pass request to patient'), ('A', 'A: Clinician will pass the request to the patient'), ('B', 'B: Clinician vetoes on clinical grounds'), ('C', 'C: Patient is definitely ineligible'), ('D', 'D: Patient is dead/discharged or details are defunct')], max_length=1)),
                ...
                ('charity_amount_due', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
            ],
        ),
        migrations.CreateModel(
            name='ConsentMode',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('decision_signed_by_patient', models.BooleanField(default=False, verbose_name='Request signed by patient?')),
                ('decision_otherwise_directly_authorized_by_patient', models.BooleanField(default=False, verbose_name='Request otherwise directly authorized by patient?')),
                ('decision_under16_signed_by_parent', models.BooleanField(default=False, verbose_name='Patient under 16 and request countersigned by parent?')),
                ('decision_under16_signed_by_clinician', models.BooleanField(default=False, verbose_name='Patient under 16 and request countersigned by clinician?')),
                ('decision_lack_capacity_signed_by_representative', models.BooleanField(default=False, verbose_name='Patient lacked capacity and request signed by authorized representative?')),
                ('decision_lack_capacity_signed_by_clinician', models.BooleanField(default=False, verbose_name='Patient lacked capacity and request countersigned by clinician?')),
                ...
                ('exclude_entirely', models.BooleanField(default=False, verbose_name='Exclude patient from Research Database entirely?')),
                ('consent_mode', models.CharField(choices=[('red', 'red'), ('yellow', 'yellow'), ('green', 'green')], default='', max_length=10, verbose_name="Consent mode ('red', 'yellow', 'green')")),
                ('consent_after_discharge', models.BooleanField(default=False, verbose_name='Consent given to contact patient after discharge?')),
                ...
                ('prefers_email', models.BooleanField(default=False, verbose_name='Patient prefers e-mail contact?')),
                ('changed_by_clinician_override', models.BooleanField(default=False, verbose_name="Consent mode changed by clinician's override?")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lookup_rid', models.CharField(max_length=128, null=True, verbose_name='Research ID used for lookup')),
                ('lookup_mrid', models.CharField(max_length=128, null=True, verbose_name='Master research ID used for lookup')),
                ...
                ('clinician_involvement', models.PositiveSmallIntegerField(choices=[(0, 'No clinician involvement required or requested'), (1, 'Clinician involvement requested by researchers'), (2, 'Clinician involvement required by YELLOW consent mode'), (3, 'Clinician involvement required by UNKNOWN consent mode')], null=True)),
                ('consent_withdrawn', models.BooleanField(default=False)),
                ('consent_withdrawn_at', models.DateTimeField(null=True, verbose_name='When consent withdrawn')),
                ('consent_mode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='consent.ConsentMode')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pt_dead', models.BooleanField(default=False, verbose_name='Patient is dead')),
                ('pt_discharged', models.NullBooleanField(verbose_name='Patient discharged')),
                ('pt_sex', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female'), ('X', 'Inderminate/intersex'), ('?', 'Unknown')], max_length=1, verbose_name='Patient sex')),
                ...
                ('clinician_signatory_title', models.CharField(blank=True, max_length=100, verbose_name="Clinician's title for signature (e.g. 'Consultant psychiatrist')")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_request', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='consent.ContactRequest')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(storage=consent.storage.CustomFileSystemStorage(base_url='download_privatestorage', location='/home/rudolf/Documents/code/crate/working/crateweb/crate_filestorage'), upload_to='')),
                ('sent_filename', models.CharField(max_length=255, null=True)),
                ('content_type', models.CharField(max_length=255, null=True)),
                ('owns_file', models.BooleanField(default=False)),
                ('email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='consent.Email')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('at', models.DateTimeField(auto_now_add=True, verbose_name='When sent')),
                ('sent', models.BooleanField(default=False)),
                ('failure_reason', models.TextField(verbose_name='Reason sending failed')),
                ('by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='emailtransmissions', to=settings.AUTH_USER_MODEL)),
                ('email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='consent.Email')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('cpft_tpir', 'CPFT: Taking part in research'), ('nihr_yhrsl', 'NIHR: Your health records save lives'), ('cpft_trafficlight_choice', 'CPFT: traffic-light choice'), ('cpft_clinres', 'CPFT: clinical research')], max_length=50, unique=True, verbose_name='leaflet name')),
                ('pdf', extra.fields.ContentTypeRestrictedFileField(blank=True, storage=consent.storage.CustomFileSystemStorage(base_url='download_privatestorage', location='/home/rudolf/Documents/code/crate/working/crateweb/crate_filestorage'), upload_to=consent.models.leaflet_upload_to)),
            ],
        ),
        migrations.CreateModel(
            name='Letter',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='When created')),
                ('pdf', models.FileField(storage=consent.storage.CustomFileSystemStorage(base_url='download_privatestorage', location='/home/rudolf/Documents/code/crate/working/crateweb/crate_filestorage'), upload_to='')),
                ('to_clinician', models.BooleanField(default=False)),
                ('to_researcher', models.BooleanField(default=False)),
                ('to_patient', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_db', models.CharField(choices=[('dummy_clinical', 'Dummy clinical database for testing'), ('cpft_crs', 'CPFT Care Records System (CRS) 2005-2012'), ('cpft_rio', 'CPFT RiO 2013-')], max_length=20, verbose_name='Source database used for lookup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decision_lack_capacity_signed_by_clinician', models.BooleanField(default=False, verbose_name='Patient lacked capacity and request countersigned by clinician?')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='When created')),
                ('response', models.PositiveSmallIntegerField(choices=[(1, '1: Yes'), (2, '2: No')], null=True, verbose_name="Patient's response")),
                ('contact_request', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='patient_response', to='consent.ContactRequest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_details_pdf', extra.fields.ContentTypeRestrictedFileField(blank=True, storage=consent.storage.CustomFileSystemStorage(base_url='download_privatestorage', location='/home/rudolf/Documents/code/crate/working/crateweb/crate_filestorage'), upload_to=consent.models.study_details_upload_to)),
                ('subject_form_template_pdf', extra.fields.ContentTypeRestrictedFileField(blank=True, storage=consent.storage.CustomFileSystemStorage(base_url='download_privatestorage', location='/home/rudolf/Documents/code/crate/working/crateweb/crate_filestorage'), upload_to=consent.models.study_form_upload_to)),
                ('lead_researcher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='studies_as_lead', to=settings.AUTH_USER_MODEL)),
                ('researchers', models.ManyToManyField(blank=True, related_name='studies_as_researcher', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('team', models.CharField(choices=[('dummy_team_one', 'dummy_team_one'), ('dummy_team_two', 'dummy_team_two'), ('dummy_team_three', 'dummy_team_three')], max_length=100, unique=True, verbose_name='Team description')),
        ...
        migrations.AddField(
            model_name='letter',
            name='study',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='consent.Study'),
        ),
        migrations.AddField(
            model_name='email',
            name='letter',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='consent.Letter'),
        ),
        migrations.AddField(
            model_name='email',
            name='study',
        ...
        migrations.AddField(
            ...
            name='patient_lookup',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='consent.PatientLookup'),
        ),
        migrations.AddField(
            model_name='contactrequest',
            name='request_by',
        ...
        migrations.AddField(
            model_name='contactrequest',
            name='study',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='consent.Study'),
        ),
        migrations.AddField(
            model_name='clinicianresponse',
            name='contact_request',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='clinician_response', to='consent.ContactRequest'),
        ),
    ]
