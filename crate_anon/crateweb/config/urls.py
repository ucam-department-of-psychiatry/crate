...
urlpatterns = [
    ...
    url(r"^query/$", research_views.query_edit_select, name=UrlNames.QUERY),
    url(
    ...
    # -------------------------------------------------------------------------
    url(r"^pe_build/$", research_views.pe_build, name=UrlNames.PE_BUILD),
    url(r"^pe_choose/$", research_views.pe_choose, name=UrlNames.PE_CHOOSE),
    url(
