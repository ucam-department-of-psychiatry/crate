...
def refresh_all_consent_modes() -> None:
    """
    Celery task to refresh all consent modes. Uses
    :meth:`crate_anon.crateweb.consent.models.ConsentMode.refresh_from_primary_clinical_record`
...
def process_consent_change(consent_mode_id: int) -> None:
    ...
    .. todo:: process_consent_change: don't process twice
...
def test_email_rdbm_task() -> None:
    ...
    Manager.
    """
    log.debug("test_email_rdbm_task")
