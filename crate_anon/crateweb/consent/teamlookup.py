...
from crate_anon.crateweb.consent.teamlookup_systmone import (
    get_cpft_systmone_teams,
)
...
def get_teams() -> List[str]:
    ...
    elif settings.CLINICAL_LOOKUP_DB == ClinicalDatabaseType.DUMMY_CLINICAL:
        return get_dummy_teams()
    elif settings.CLINICAL_LOOKUP_DB == ClinicalDatabaseType.CPFT_SYSTMONE:
        return get_cpft_systmone_teams()
    else:
        return []
