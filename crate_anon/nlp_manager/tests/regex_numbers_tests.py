...
class TestNumberRegexes(unittest.TestCase):
    ...
    def test_number_regexes() -> None:
        ...
        # Operators, etc.
        # ---------------------------------------------------------------------
        assert_text_regex("MULTIPLY", MULTIPLY, [
            ("a * b", ["*"]),
            ("a x b", ["x"]),
            ("a × b", ["×"]),
            ("a ⋅ b", ["⋅"]),
        ...
        assert_text_regex("POWER_INC_E", POWER_INC_E, [
            ("a ^ b", ["^"]),
            ("a ** b", ["**"]),
            ("10e5", ["e"]),
            ("10E5", ["E"]),
        ...
        assert_text_regex("BILLION", BILLION, [
            ("10 x 10^9/l", ["x 10^9"]),
        ], verbose=verbose)
        assert_text_regex("PLUS_SIGN", PLUS_SIGN, [
            ("a + b", ["+"]),
            ("a blah b", []),
        ], verbose=verbose)
        assert_text_regex("MINUS_SIGN", MINUS_SIGN, [
            # good:
        ...
        assert_text_regex("TRILLION", TRILLION, [
            ("* 10^12", ["* 10^12"]),
            ("× 10e12", ["× 10e12"]),
            ("x 10 ** 12", ["x 10 ** 12"]),
        ], verbose=verbose)
        ...
        assert_text_regex("PLAIN_INTEGER", PLAIN_INTEGER, [
            ("a 1234 b", ["1234"]),
            ("a 1234.5 b", ["1234", "5"]),
            ("a 12,000 b", ["12", "000"]),
        ], verbose=verbose)
        ...
        assert_text_regex("IGNORESIGN_FLOAT", IGNORESIGN_FLOAT, [
            ("1", ["1"]),
            ("12345", ["12345"]),
        ...
        assert_text_regex("IGNORESIGN_INTEGER", IGNORESIGN_INTEGER, [
            ("1", ["1"]),
            ("12345", ["12345"]),
            ("-1", ["1"]),  # will drop sign
            ("1.2", ["1", "2"]),
        ...
        assert_text_regex("LIBERAL_NUMBER", LIBERAL_NUMBER, [
            ("1", ["1"]),
            ("12345", ["12345"]),
            ("-1", ["-1"]),
            ("1.2", ["1.2"]),
        ...
        assert_text_regex("SIGNED_FLOAT", SIGNED_FLOAT, [
            ("1", ["1"]),
            ("12345", ["12345"]),
            ("-1", ["-1"]),
            ("1.2", ["1.2"]),
        ...
        assert_text_regex("SIGNED_INTEGER", SIGNED_INTEGER, [
            ("1", ["1"]),
            ("12345", ["12345"]),
            ("-1", ["-1"]),
            ("1.2", ["1", "2"]),
        ...
        assert_text_regex("UNSIGNED_FLOAT", UNSIGNED_FLOAT, [
            ("1", ["1"]),
            ("12345", ["12345"]),
            ("-1", []),
            ("1.2", ["1.2"]),
        ...
        assert_text_regex("UNSIGNED_INTEGER", UNSIGNED_INTEGER, [
            ("12345", ["12345"]),
            ("+12345", ["+12345"]),
            ("-12345", []),
            ("-12345.67", []),
