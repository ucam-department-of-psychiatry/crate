...
# installer/example_scripts/stop_crate.sh
...
# Stops the CRATE Docker containers. This is the equivalent to:
...
${PYTHON} "${CRATE_HOST_INSTALLER_BASE_DIR}/installer.py" stop
