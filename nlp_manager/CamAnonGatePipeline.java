...
public class CamAnonGatePipeline {
    ...
    // Constants
    private static final String m_defaultlogprefix = "camanongatepipeline:";
    ...
    public CamAnonGatePipeline(String args[])
    ...
    private void usage() {
        status(
"usage: CamAnonGatePipeline -g GATEAPP [-a ANN [-a ANN [...]]] [-e ENCODING]\n" +
...
"  -wt FILESTEM     Write TSV-format annotations FILESTEM<n>.tsv.\n",
    ...
    public static void main(String args[]) throws GateException, IOException {
        CamAnonGatePipeline annie = new CamAnonGatePipeline(args);
    }
}
