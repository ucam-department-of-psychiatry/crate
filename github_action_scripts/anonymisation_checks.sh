...
anonymised=$(docker compose exec -T research_db mysql -Ns -u research -presearch research -e "SELECT SUBSTR(note, 1, 40) FROM note LIMIT 1")
[ "${anonymised}" = "I saw [__PPP__] [__PPP__] on 01 Jan 2000" ]
